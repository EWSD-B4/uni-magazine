...
// const generateUsers = () => {
//   const users = []
//   const names = ["Thiri Yadanar", "Khaing Thinzar Thwe", "Aung Htet Nay", "Win Nandar Kyaw", "Nay Win Hlaing"]
...
//       const facultyMatch = selectedFaculty === "All Faculties" || user.faculty === selectedFaculty
...
//   // Table Actions
//   const tableActions = [
//     { label: "Reset Password", onClick: (row) => alert(`Reset Password for ${row.name}`) },
//     { label: "Edit Account", onClick: (row) => alert(`Edit Account for ${row.name}`) },
//     {
//       label: "Deactivate Account",
//       onClick: (row) => alert(`Deactivate Account for ${row.name}`)
//     },
//     {
...
//         )
//         if (confirmDelete) {
//           alert(`Deleted ${row.name}'s account!`)
//           // Here you can remove the user from your data if you have a real backend
//         }
//       }
//     },
//   ]
...
//         <StatCard label="Marketing Coordinators" value={42} />
//         <StatCard label="Marketing Managers" value={856} />
//         <StatCard label="Guests" value={6} />
//       </div>
