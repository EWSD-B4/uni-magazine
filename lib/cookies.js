...
const FACULTY_ID_COOKIE = "um_faculty_id"
...
export async function getAuthFromCookies() {
  ...
  return {
    ...
    facultyId: store.get(FACULTY_ID_COOKIE)?.value || null,
...
export async function setAuthCookies({
  ...
  if (facultyId !== undefined && facultyId !== null && facultyId !== "") {
    store.set(FACULTY_ID_COOKIE, String(facultyId), {
      httpOnly: true,
      sameSite: "lax",
      path: "/",
    })
  } else {
    store.delete(FACULTY_ID_COOKIE)
  }
